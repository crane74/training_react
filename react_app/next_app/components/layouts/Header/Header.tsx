...
import NavPopover from "@/components/elements/NavPopover";
        ...
        <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden space-x-10 md:flex">
            <NavPopover
              title="Solutions"
              position={false}
              VerticalPanelIcon={solutions}
              HorizontalPanelIcon={callsToAction}
            />
            ...
            <NavPopover
              title="More"
              position
              VerticalPanelIcon={resources}
              VerticalPanel={recentPosts}
              main="RecentPosts"
              sub="View all posts"
            />
          </Popover.Group>
